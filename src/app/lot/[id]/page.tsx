        ...
        <main className="flex-1 flex items-center justify-center">
          <div className="text-center px-4 py-24">
            ...
            <p className="text-warm-gray mb-8 max-w-md mx-auto">
              The lot you are looking for does not exist or may have been
  ...
  const AccordionSection = ({
    ...
    return (
      <div className="border-b border-border-light last:border-b-0">
        ...
        >
          <h3 className="font-[family-name:var(--font-heading)] text-lg font-semibold text-navy group-hover:text-gold transition-colors">
            {title}
          </h3>
          {isOpen ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <h1 className="font-[family-name:var(--font-heading)] text-3xl lg:text-4xl font-bold text-navy leading-tight mb-4">
                  {lot.title}
                </h1>
              ...
              <div className="bg-white rounded-xl border-2 border-gold/30 p-6 shadow-sm">
                ...
                <div className="mb-4">
                  ...
                  <p className="font-[family-name:var(--font-heading)] text-4xl lg:text-5xl font-bold text-navy">
              ...
              {lotBids.length > 0 && (
                ...
                >
                  <h3 className="font-[family-name:var(--font-heading)] text-xl font-semibold text-navy mb-4 flex items-center gap-2">
        ...
        {relatedLots.length > 0 && (
          <section className="border-t border-border-light bg-warm-white">
            <div className="max-w-7xl mx-auto px-4 py-12 lg:py-16">
              <h2 className="font-[family-name:var(--font-heading)] text-3xl font-bold text-navy text-center mb-10">
                You May Also Like
              </h2>
